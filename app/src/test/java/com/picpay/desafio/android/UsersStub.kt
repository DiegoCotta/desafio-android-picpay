...
object UsersStub {
    ...
    val listUsers = listOf(
        User(img = "img 1", name = "name 1", username = "user name 1", id = 1L),
        User(img = "img 2", name = "name 2", username = "user name 2", id = 2L)
    )

    val user = User(img = "img 1", name = "name 1", username = "user name 1", id = 1L)
